...
#+begin_src emacs-lisp
  (use-package org-gtd
    ...
    (org-agenda-property-list '("DELEGATED_TO")) ;; REQUIRED
    ;; package: https://www.nongnu.org/org-edna-el/
    ;; org-edna is used to make sure that when a project task gets DONE,
    ;; the next TODO is automatically changed to NEXT.
    (org-edna-use-inheritance t) ;; REQUIRED
    :config
    ;; without this, org-edna won't trigger
    (org-edna-mode 1) ;; REQUIRED
    :bind
    ...
    :init
    (bind-key "C-c c" 'org-gtd-clarify-finalize)) ;; the keybinding to hit when you're done processing an inbox item ;; REQUIRED
  ...
  (use-package org-agenda
    ...
    (org-agenda-files `(,org-gtd-directory)) ;; REQUIRED
