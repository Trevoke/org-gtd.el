...
;;   - Reusable helpers (clarifying, processing, etc.)
;;
...
;; This file is at test/helpers/prelude.el
(eval-and-compile
...
;; Load framework-agnostic helpers from same directory
...
(require 'org-gtd-test-helper-builders (ogt-eunit--relative-path "builders.el"))
(require 'org-gtd-test-helper-clarifying (ogt-eunit--relative-path "clarifying.el"))
(require 'org-gtd-test-helper-processing (ogt-eunit--relative-path "processing.el"))
(require 'org-gtd-test-helper-wip (ogt-eunit--relative-path "wip.el"))
(require 'org-gtd-test-helper-utils (ogt-eunit--relative-path "utils.el"))

;; Domain assertions (query functions are framework-agnostic)
(require 'ogt-assertions (ogt-eunit--relative-path "assertions.el"))

;; Keyboard integration helpers for end-to-end testing
(require 'keyboard-integration (ogt-eunit--relative-path "keyboard-integration.el"))
