...
;; Then specify which GTD types should prompt
...
;; Set this to get prompted for where to refile (see your targets)
(setq org-gtd-refile-to-any-target nil)
...
| Refile with your targets | Set ~org-gtd-refile-to-any-target~ to nil |
