...
This is how org-gtd queries work. All standard org-ql compatible.
...
org-gtd uses a declarative view language built on org-ql:
...
Available filters:
- ~todo~ - keyword match
- ~tags~ - tag expression (supports ~|~ for OR)
- ~priority~ - priority level
- ~area-of-focus~ - GTD area
- ~type~ - item type (action, project, delegated, etc.)
...
For complete documentation: ~C-h i m org gtd RET~
