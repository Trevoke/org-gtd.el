...
- ~filters~ :: What to show (type, TODO state, tags, dates, etc.)
...
*Filter by type (item type):*
#+begin_src emacs-lisp
(filters . ((type . project)))      ; All projects
(filters . ((type . next-action)))       ; Single actions
(filters . ((type . delegated)))     ; Delegated items
(filters . ((type . calendar)))      ; Calendar items
(filters . ((type . stuck-project))) ; Stuck projects only
#+end_src
...
*Matches*: Items with ~ORG_GTD="Delegated"~
...
*Matches*: Items with ~ORG_GTD="Habit"~
...
*Matches*: Single action items (~ORG_GTD="Actions"~)
