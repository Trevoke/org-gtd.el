...
- New ~org-gtd-reflect-someday-maybe~ command for reviewing someday items
...
*How to review*: Use ~org-gtd-reflect-someday-maybe~ to periodically review all someday items and decide if any are ready to become active projects or actions.
