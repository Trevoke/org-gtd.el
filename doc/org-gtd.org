...
See [[#defining-your-own-agenda-views][Defining your own agenda views]] in the "Using Org GTD" section for more advanced examples and the full filter reference.
...
For details on each step, see the subsections below.
...
- Applying hooks to add additional relevant information (see [[#hooks-framework][Customization: Hooks]])
