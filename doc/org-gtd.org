...
**What it is:** Bring back tickler projects and actions.

**Why you'd use it:** The review date arrived, you're ready to work on it again.

**Your first use (30 seconds):**

1. When you see a tickler item in agenda (on its review date)
...
- Restores original item states (tickler → Projects, actions → Actions, etc.)
...
- During weekly review when scanning tickler items
