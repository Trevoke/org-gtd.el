...
This is the complete command reference for expert users. Press ~?~ in graph view to see the full command menu.
...
| Key   | Command                    | Description                                              |
|-------+----------------------------+----------------------------------------------------------|
| a     | Add dependency             | Add dependency between two tasks (supports convergence)  |
