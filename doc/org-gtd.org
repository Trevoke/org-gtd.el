...
In order to add areas of focus to pre-existing items in your system, without going through the clarifying flow, we provide ~org-gtd-area-of-focus-set-on-item-at-point~.
